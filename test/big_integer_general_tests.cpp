...
TYPED_TEST(BigIntegerTest, MultiplyTwoBigInteger) {
    ...
    EXPECT_EQ(BInt("999999999999999999999999999999")
                      .Mul(BInt("999999999999999999999999999999"))
                      .ConvertToString(),
...
TYPED_TEST(BigIntegerTest, MultiplyEqTwoBigInteger) {
    ...
    num *= BInt("999999999999999999999999999999");
    EXPECT_EQ(num.ConvertToString(),
              "999999999999999999999999999998000000000000000000000000000001");

    num *= BInt("-999999999999999999999999999999");
    EXPECT_EQ(num.ConvertToString(),
              "-999999999999999999999999999997000000000000000000000000000002999"
...
TYPED_TEST(BigIntegerTest, DivideTwoBigInteger) {
    ...
    EXPECT_EQ(num.ConvertToString(), "3");

    EXPECT_EQ(BInt("99999999999999999999999999999")
...
TYPED_TEST(BigIntegerTest, BitwiseXor) {
    ...
    BInt num = BInt("-1234567890123456789012345678901234567890");
    EXPECT_TRUE(num.XorEq(BInt("-9876543210987654321098765432109876543210")) ==
                BInt("10429788288481127546160455888863017661496"));
    EXPECT_TRUE(num == BInt("10429788288481127546160455888863017661496"));

    EXPECT_TRUE((BInt("-1234567890123456789012345678901234567890") ^
                 BInt("-9876543210987654321098765432109876543210")) ==
                BInt("10429788288481127546160455888863017661496"));
